...
export type OmnibusQueryQuery = { __typename?: 'QueryRoot', scans: Array<{ __typename?: 'Scan', id?: number | null, status: string, path: string, scannedAt: any, scanner: string, rotation: number, cropCoordinates?: string | null, scanParameters: any, group?: { __typename?: 'ScanGroup', id: number, title: string, comment: string, createdAt: any, status: string, tags: Array<string>, updatedAt: any } | null, originalPath?: { __typename?: 'AssetPath', path: string } | null, editedPath?: { __typename?: 'AssetPath', path: string } | null }>, dividers: Array<{ __typename?: 'ScanDivider', id?: number | null, ts: any }> };
